...
<div class="wrapper" style="background-color:whitesmoke;">
  ...
  <div class="content-wrapper" style="background-color:window;">
    ...
    <section class="content">
      ...
      ?>
	  <emp style="font-size:17px;">DTR - Daily Time Record</emp>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
              ...
              <div class="pull-right">
                <form method="POST" class="form-inline" id="payForm">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control pull-right col-sm-8" id="reservation" name="date_range" value="<?php echo (isset($_GET['range'])) ? $_GET['range'] : $range_from.' - '.$range_to; ?>sas">
                  </div>
            ...
            <div class="box-body">
             <table id="example1" class="table table-bordered">
				...
				//  SELECT *, attendance.employee_id AS attid, employees.id AS empid FROM employees LEFT JOIN attendance ON //attendance.employee_id=employees.id WHERE attendance.date ='2019-10-31' IS NULL
				           $get_id=$_GET['id']; 
				  	$date_now = date('Y-m-d');
                    $sql = "SELECT *, employees.employee_id AS empid, attendance.id AS attid FROM attendance LEFT JOIN employees ON employees.id=attendance.employee_id WHERE date BETWEEN '$from' AND '$to' AND employees.id='$get_id'";
