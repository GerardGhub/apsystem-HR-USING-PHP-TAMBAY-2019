...
<div class="wrapper">
    ...
    <section class="content-header">
      <!--h1>
        Schedules
	      ...
	      <img src="images/GerardSs.jpg" height="40"></img><emp style="font-size:17px;">&nbsp;Types Of Leave</emp>
      <ol class="breadcrumb">
  ...
  <?php include 'includes/tol_modal.php'; ?>
</div>
