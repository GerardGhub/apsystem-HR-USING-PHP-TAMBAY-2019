          ...
          <div class="box">
			...
			<th style="width:11%;background-color:#454545; color:white; text-align:center; ">No. Employee</th>
				...
				<th style="width:11%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;">Incomple Logs</th>
					<th style="width:7%;background-color:#454545; color:white; text-align:center; ">Generate All Department_ID</th>
...
<?php echo $countsx; ?>
		  ...
		  <td style="width:5%;">
		    ...
		    <a  rel="tooltip"  class="btn btn-primary" title="Print the Sticker" id="v<?php echo $id;?>" target="_blank" href="printIDmultiple.php?id=<?php echo $department;?>" class="btn btn-light"><span class="glyphicon glyphicon-print" style="font-size:17px; width:180px;text-align:center; color:white"></span></i></a>
			</td>
        ...
        <td width="140" style="text-align:center;">
                <a  rel="tooltip"  title="View" id="v<?php echo $id; ?>"  href="employeekorea.php?id=<?php echo $row['department'];?>" class="btn btn-success">View Employees DataList<i class="icon-list icon-large"></i></a>
           </td>
      </tr>
      <?php } ?>
                                </tbody>
