...
<div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
		  ...
		  <th style="width:4%;background-color:#454545; color:white; border-radisus:15px; text-align:center; font-size:15px; color:white;">Print_DTR</th>
 ...
 <a href="#edit_photos<?php echo $row ['empid'];?>" data-toggle="modal" class="pull-right photo" data-id="<?php echo $row['empid']; ?>"><span class="fa fa-edit"></span></a>
	  </td>
...
glyphicon glyphicon-cloud-upload" style="text-align:center; color:white"></span><i class="icon-trash icon-large"></i>&nbsp;Upload</a-->
		         ...
		         <a  rel="tooltip"  title="View" id="v<?php echo $id; ?>"  href="printalldtr.php?id=<?php echo $row['empid'];?>" class="btn btn-info">Print&nbsp;ALL&nbsp;DTR<i class="icon-list icon-large"></i></a>							   
				
				</td>
				
					<td style="width:5%;">					
											   
                <a  rel="tooltip"  title="View" id="v<?php echo $id; ?>"  href="gerard1.php?id=<?php echo $row['empid'];?>" class="btn btn-primary">View Employee DTR<i class="icon-list icon-large"></i></a>
						</td>			
...
<td style="width:5%;">
 	...
 	<a href="#update<?php echo $row ['empid'];?>"  class="btn btn-warning <?php echo $row['system_status'];?>" title="Click to Edit" data-toggle="modal"></span>Edit</a>			
...
$(function(){
  ...
  $("#reservation").on('change', function(){
    ...
    window.location = 'gerard2.php?range='+range;
  });
