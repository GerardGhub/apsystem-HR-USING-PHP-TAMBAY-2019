...
<h2 style="text-align:center;font-size:50px;">HR DEPARTMENT TIMEKEEPING USING BARCODE</h2>
...
<div class="row">
  <div class="column" style="background-color:window;">
	...
	<?php
    $sql = "SELECT *, employees.employee_id AS empid, attendance.id AS attid FROM attendance LEFT JOIN employees ON employees.id=attendance.employee_id ORDER BY attendance.date DESC, attendance.time_in DESC LIMIT 1";
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
						  ...
						  <td> <img src=images/".$row['photo']." style='width:340px; height:200px;' height='210' class='zooms'></td>
	...
	<p>
	<b style="font-size:30px; text-align:center;"><span class='message22'></span></b>
    	...
    	<form id="attendance">
          ...
          <!--/div-->
      		<div class="form-group has-feedback">
        		<input type="text" class="form-control input-lg" id="employee" name="employee" autofocus autorequired>
        		<span class="glyphicon glyphicon-calendar form-control-feedback"></span>
      		</div>
      		<div class="row">
    			<div class="col-xs-4">
          			<button type="submit" onclick="location.href = 'indexmain.php';" id="myButton" class="btn btn-primary btn-block btn-flat" name="signin"><i class="fa fa-sign-in"></i> Sign In</button>
        		</div>
      		</div>
    	</form>
  	</div>
